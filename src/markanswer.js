...
exports.markAnswer = async(ctx) => {
    ...
    if(user.mode == 'live'){
        ...
        if(question != null){
            ...
            let nextquestion = await models.Question.findOne({
                limit: 1,
                where: {
                    id: {
                        [Op.gt]: user.lastqid
            ...
            if(nextquestion != null && nextquestion instanceof models.Question){
                
                if(nextquestion.type == 1){
                    const modeText =`
<b>Mode:</b> Live 
<b>Category: </b> Standard
